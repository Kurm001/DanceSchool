...
//        notificationIntent.putExtra(MainListAdapter.IS_EMERGENCY, true);
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        if (names.get(position).toString().equals("ATTENDANCE")) {
            ...
            imageView.setImageResource(R.drawable.ic_audiotrack_24px);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    public static class createRequest extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            Cursor cr = Login.handler.execQuery(qu);
            if (cr != null) {
                cr.moveToFirst();
            ...
            builder.setView(v)
                    ...
                    .setPositiveButton("Enter", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            Cursor cr = Login.handler.execQuery(qx);
                            String subnames = "";
                            if (cr != null) {
                                cr.moveToFirst();
                                while (!cr.isAfterLast()) {
                            ...
                            Cursor cursor = Login.handler.execQuery("SELECT * FROM ATTENDANCE WHERE datex = '" +
